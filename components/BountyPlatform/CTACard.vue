<template>
  <div
    ...
    "
    class="w-full flex flex-col relative overflow-hidden flex-wrap justify-center items-center bg-dtSecondary py-6 md:py-10 px-6 md:px-8 rounded-b-3xl"
  >
    ...
    <button
      ...
      class="hover_scale-md bg-dtText text-dtSecondary btn-textSecondary font-extrabold text-xl rounded-tl-2xl rounded-br-2xl rounded-tr-md rounded-bl-md px-8 py-2"
