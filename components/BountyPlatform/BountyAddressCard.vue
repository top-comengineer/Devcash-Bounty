<template>
  <div class="w-full flex flex-row flex-wrap justify-center rounded-xl px-4 py-2 shadow-xl border border-c-text-10">
    <div class="flex flex-col justify-center items-center mx-3 mt-3 mb-4">
      ...
      <div class="flex flex-row flex-wrap items-center">
        ...
        <button @click.prevent="copyAddress()"
    ...
    <!-- QR Code -->
    <div class="flex flex-row justify-center h-32 w-32 rounded-lg overflow-hidden border-3 border-c-primary my-4 mx-1">
      <vue-qr :text="qrValue" :size="400" :logoScale="0.3" :logoSize="40" :correctLevel="2" :logoMargin="0"
        :logoBackgroundColor="'rgba(255, 255, 255, 0)'"
        :logoSrc="require('~/assets/images/icons/eth-avatar.svg')"></vue-qr>
    </div>
  </div>
</template>
<script>
