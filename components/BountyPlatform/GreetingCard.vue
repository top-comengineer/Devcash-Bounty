<template>
  <div
    ...
    "
    class="w-full flex flex-col relative overflow-hidden flex-wrap justify-center items-center bg-dtPrimary py-6 md:py-10 px-6 md:px-8 rounded-tl-3xl rounded-br-3xl rounded-tr-lg rounded-bl-lg"
  >
