<template>
  <div
    ...
    <div class="w-full md:w-6/12 lg:w-7/12 flex flex-row justify-start items-center my-2">
      ...
      <!-- Message -->
      <a v-if="item && item.blockHash && messageType == 'rewarded'" :href="'https://etherscan.io/tx/' + item.blockHash"
        v-html="formattedMessage()" class="text-left px-4 hover:underline" target="_blank"></a>
    ...
    <div class="w-full md:w-5/12 lg:w-4/12 flex flex-col justify-end my-2">
      ...
      <div v-if="address" class="flex flex-row justify-start md:justify-end">
        <div class="bg-c-background-ter flex flex-row justify-start md:justify-end items-center rounded-full mb-2">
