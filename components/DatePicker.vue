  ...
  <div ref="datepicker">
    <div class="bg-c-text text-c-background rounded-lg shadow-2xlS p-4" style="width: 17rem">
      <div class="flex justify-between items-center mb-2">
        ...
        <div>
          <button type="button" :disabled="futureOnly && today.getFullYear() == year && today.getMonth() == month"
      ...
      <div class="flex flex-wrap -mx-1">
        <div v-for="(blankday, index) in blankdays" :key="'blank' + index" style="width: 14.28%"
          class="text-center border p-1 border-transparent text-sm"></div>
        <div v-for="(date, dateIndex) in no_of_days" :key="dateIndex" style="width: 14.28%" class="px-1 mb-2">
