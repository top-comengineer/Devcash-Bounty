<template>
  <div class="d-container">
    <div class="w-full flex flex-row flex-wrap justify-center items-center pt-8 pb-12 lg:py-12">
      ...
      <div class="w-full flex flex-row flex-wrap justify-center">
        ...
        <div class="w-full md:w-1/2 lg:w-2/5 px-4 py-2 md:pl-6 md:pr-3 mt-3 relative">
          ...
          <IllustrationBrackets
            class="hidden md:block md:w-64 lg:w-72 h-auto absolute left-0 bottom-0 md:-ml-24 lg:-ml-32 md:-mb-20 lg:-mb-20 z-0"
          />
          <!-- Post Bounties Card -->
          <div
        ...
        <div class="w-full md:w-1/2 lg:w-2/5 px-4 py-2 md:pr-6 md:pl-3 mt-3 relative">
          ...
          <IllustrationCode
            class="hidden md:block md:w-56 lg:w-64 h-auto absolute top-0 right-0 md:-mr-32 lg:-mr-40 md:-mt-24 lg:-mt-36 z-0"
          />
          <!-- Hunt Bounties Card -->
          <div
            class="w-full flex flex-col bg-dtBackground items-center rounded-tl-xl4 rounded-br-xl4 rounded-tr-xl rounded-bl-xl border-2 border-dtPrimary px-4 py-6 relative"
