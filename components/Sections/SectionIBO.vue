<template>
  <div class="relative overflow-hidden">
    ...
    <IllustrationSingleD
      class="w-32 md:w-48 lg:w-64 h-auto absolute right-0 top-0 -mr-8 md:-mr-10 lg:-mr-16"
    />
    <div class="d-container relative z-10">
      <div
        class="w-full flex flex-row flex-wrap justify-center lg:justify-around items-center pt-12 pb-12 md:pt-16 md:pb-16 lg:pt-24 lg:pb-40"
      >
        <div class="w-full md:w-4/5 lg:w-2/5 flex flex-col py-8 px-6">
          ...
          <!-- Paragraph Text -->
          <p
            class="text-lg text-dtText text-center lg:text-left mt-2"
          >{{$t('IBOSection.paragraph')}}</p>
        </div>
        <!-- Illustration -->
        <IllustrationIBO class="w-10/12 md:w-2/4 lg:w-1/3 order-first lg:order-last" />
      </div>
    </div>
    <!-- Background Illustration Cube -->
    <IllustrationCube
      class="w-32 md:w-48 lg:w-64 h-auto absolute bottom-0 left-0 -ml-8 md:-ml-10 lg:-ml-16"
    />
  </div>
</template>
<script>
