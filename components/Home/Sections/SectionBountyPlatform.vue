<template>
  <div class="overflow-x-hidden">
    <div class="d-container">
      <div class="w-full flex flex-row flex-wrap justify-center items-center pt-8 pb-12 lg:pt-12 md:pb-24">
        <div class="w-full flex flex-col items-center">
          <!-- Header Text -->
          <h2 class="text-c-primary font-bold text-2xl md:text-3xl text-center leading-tight px-6">{{
        ...
        <div class="w-full flex flex-row flex-wrap justify-center">
          ...
          <div class="w-full hidden md:flex flex-col items-center mt-2 px-6">
            <img class="md:w-1/2 lg:w-2/5" :src="require('~/assets/images/illustrations/foreground/indicator.svg')"
          ...
          <div class="w-full md:w-1/2 lg:w-2/5 px-4 py-2 md:pl-6 md:pr-3 mt-3 relative">
            ...
            <img
              ...
              :src="require('~/assets/images/illustrations/background/brackets.svg')" alt="Brackets Illustration" />
            <!-- Post Bounties Card -->
            <div
              class="bg-c-background w-full flex flex-col items-center rounded-tl-4xl rounded-br-4xl rounded-tr-xl rounded-bl-xl border-2 border-c-primary px-4 py-6 relative">
              <!-- Post Bounties Header -->
              <h3 class="text-c-primary font-bold text-xl md:text-2xl text-center leading-tight px-6">{{
                $t("home.bountyPlatformSection.postBountyHeader") }}</h3>
              <!-- Post Bounties Paragraph -->
              <p class="text-lg text-center mt-2 px-4">{{ $t("home.bountyPlatformSection.postBountyParagraph") }}</p>
              <!-- Post Bounties Illustration -->
              <img class="w-3/4 h-auto mt-8 mb-5"
              ...
              <div class="flex flex-row justify-center">
                <nuxt-link :to="localePath('bountyplatform-post')"
                  class="btn-primary bg-c-primary text-c-light transform hover:scale-md focus:scale-md transition-all duration-200 ease-out origin-bottom-left font-extrabold text-xl rounded-tl-2xl rounded-br-2xl rounded-tr-md rounded-bl-md px-12 py-2 my-4">{{
          ...
          <div class="w-full md:w-1/2 lg:w-2/5 px-4 py-2 md:pr-6 md:pl-3 mt-3 relative">
            ...
            <img
              ...
              :src="require('~/assets/images/illustrations/background/code.svg')" alt="Code Illustration" />
            <!-- Hunt Bounties Card -->
            <div
              class="bg-c-background w-full flex flex-col items-center rounded-tl-4xl rounded-br-4xl rounded-tr-xl rounded-bl-xl border-2 border-c-primary px-4 py-6 relative">
              ...
              <p class="text-lg text-center mt-2 px-4">{{ $t("home.bountyPlatformSection.huntBountyParagraph") }}</p>
